    ...
    <body class="bg-gray-100">
       <header class="p-5 border-b bg-white shadow">
        <div class="container mx-auto flex justify-between">
            ...
            <!--Para saber si un usuario esta autenticado o no usamos la condicion-->
           

            @auth
            <!--Este es el Nav el menu superior-->
                <nav class="flex gap-2 items-center">
                    <a class="flex items-center gap-2 bg-white border p-2 text-gray-600 rounded text-sm
                    uppercase font-bold cursor-pointer"
                    href="{{route('posts.create')}}"
                    >
                        <!--la imagen sacada de la pagina-->
                ...
                <!--Aqui fin del Nav el menu superior-->
                <form action="#" method="GET" class="flex items-center">
                    <input type="text" name="query" placeholder="Buscar..." class="border p-2 rounded-md">
        ...
        <footer class=" mt-10 text-center p-5 text-gray-500 font-bold uppercase">
            ...
            <!--todo lo que esta dentro de {{}} es codigo php-->
